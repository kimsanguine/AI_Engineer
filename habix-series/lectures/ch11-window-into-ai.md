...
<!-- SCREENSHOT v1.1
  위치: ch11-window-into-ai.md:24
  before: Claude 청구서 "$47" 충격 — 무엇을 썼는지 모름
  after: "어제 12.4K 토큰 · 도구 18회 · 파일 변경 3개" 한 줄 요약
-->
| | Before | After |
|---|---|---|
| **스크린샷** | *Claude 청구서 "$47" 충격 — 무엇을 썼는지 모름* *(v1.1 예정)* | *"어제 12.4K 토큰 · 도구 18회 · 파일 변경 3개" 한 줄 요약* *(v1.1 예정)* |
